    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
        {missionPoints.map((point, index) => (
          <div
            key={index}
            className="bg-white h-[215px] md:w-[283px] text-black rounded-2xl shadow-md p-6 relative text-center"
            style={{
          ...
          >
            <h3 className="font-bold inline text-orange-600 mb-2">{point.title}</h3>
            <p className="text-gray-700 inline text-base leading-relaxed">
              {point.description}
            </p>
